...
#        logmessage = crash_bin.crash_synopsis()
	logmessage = "Crashed at %x!" % exception_address       
...
class PAIMEIfilefuzz(wx.Panel):
    ...
    def __set_properties(self):
        ...
        self.file_view_control.SetFont(wx.Font(12, wx.TELETYPE, wx.NORMAL, wx.NORMAL, 0, "Courier New"))
        ...
        self.log.SetFont(wx.Font(8, wx.MODERN, wx.NORMAL, wx.NORMAL, 0, "Courier New"))
