...
static main()
{
    ...
    if (tolower(this_module) == "calculator")
    {

        color = 0x3c0000;
        if (GetColor(base + 0x00007516, CIC_ITEM) == DEFCOLOR)
            assign_block_color_to(base + 0x00007516, color);


        color = 0x3c0000;
        if (GetColor(base + 0x000076bd, CIC_ITEM) == DEFCOLOR)
            assign_block_color_to(base + 0x000076bd, color);


        color = 0x3c0000;
        if (GetColor(base + 0x00002d36, CIC_ITEM) == DEFCOLOR)
            assign_block_color_to(base + 0x00002d36, color);
