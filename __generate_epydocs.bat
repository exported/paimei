...
%PythonPath%\python.exe %PythonPath%\Scripts\epydoc.py -o docs\BakMei      --css blue --name "Bak Mei - The back end roots of Pai Mei"           --url "http://www.openrce.org" bakmei\defines.py bakmei\basic_block.py bakmei\function.py bakmei\instruction.py bakmei\module.py bakmei\sql_singleton.py
