...
static main()
{
    ...
    if (tolower(this_module) == "calculate")
    {
        ...
        color = 0x3c0000;
        if (GetColor(base + 0x00003cbc, CIC_ITEM) == DEFCOLOR)
            assign_block_color_to(base + 0x00003cbc, color);


        color = 0x3c0000;
        if (GetColor(base + 0x00003d29, CIC_ITEM) == DEFCOLOR)
            assign_block_color_to(base + 0x00003d29, color);


        color = 0x3c0000;
        if (GetColor(base + 0x00003d48, CIC_ITEM) == DEFCOLOR)
            assign_block_color_to(base + 0x00003d48, color);


        color = 0x3c0000;
        if (GetColor(base + 0x00003d1d, CIC_ITEM) == DEFCOLOR)
            assign_block_color_to(base + 0x00003d1d, color);
